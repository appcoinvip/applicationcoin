...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "APPC - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "APPC Core", 0));
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Shadow help message to get a list with possible Shadow command-line options.", 0));
#endif // QT_NO_TOOLTIP
