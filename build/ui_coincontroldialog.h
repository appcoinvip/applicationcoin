...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 APPC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 APPC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 APPC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 APPC"));
